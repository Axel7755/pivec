    ...
    duda: {
      ...
      descriptions: {
        "text": [
          ...
          "Google Docs: Facilita la visualización y edición de documentos colaborativos en línea creando una copia editable en tu drive.",
          "Crear tarea: Accede a la funcionalidad para generar tus entregas de tareas, especificando los detalles solicitados.",
          "Revisar tarea: Aquí puedes consultar las calificaciones y retroalimentaciones de tus tareas entregadas.",
